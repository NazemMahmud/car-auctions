...
public class DbInitializer
{
    ...
    {
        /**
        * here, using is used for: this will allow the framework once we're finished with this method to dispose of
        * any of the services we've used inside this scope that we're creating, and then we'll call another method
        */
    ...
    {
        /**
        * it will look at the migrations apply any that have not already been applied.
        * if the database has not even been created at this point, it's actually going to create a database as well.
        */
        context.Database.Migrate();
        
        // if already data is seeded, there is no need of action
